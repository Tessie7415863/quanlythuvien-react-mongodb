    ...
    return (
        <nav className="bg-white border-gray-200 dark:bg-gray-900">
            <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                ...
                {dataUser ? <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <h3 className="text-sm font-bold text-gray-600">Xin chào, {dataUser.email}</h3>
                    <button onClick={() => signOut()}>Đăng xuất</button>
                </div> : <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                    <a href='login' type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</a>
